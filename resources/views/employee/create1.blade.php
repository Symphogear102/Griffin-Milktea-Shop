...
<h3 class="form">Add Task</h3>
 ...
 <input type="text" class="form-control" name="zCode" id="zCode" value="{{$user->zFirst}}" recquired>
 </div>

 <div class="form">
 <label for="zCode">Code:</label>
 <input type="text" class="form-control" name="zStat" id="zStat" value="{{ Auth::user('id')->zFirst }}"  recquired>
 </div>

 <div class="form">
 <label for="zFirst">First Name:</label>
 <input type="text" class="form-control" name="zFirst" id="zFirst" value="" recquired>
 </div>
