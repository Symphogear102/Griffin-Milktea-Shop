...
<table id="customers1">
<br><br>
<h3 class="form">Order For Costumer</h3>
...
<center>
 ...
 <div class="form">
 <input type="hidden" class="form-control" name="zFirst" id="zFirst" value="OrderBy:{{ Auth::user()->uFirst }}" readonly>
 </div>
 ...
 <div class="form">
 <input type="hidden" class="form-control" name="zAdd" id="zAdd" value="In-MilkteaShop" readonly>
 </div>

 <div class="form">
 <input type="hidden" class="form-control" name="zStreet" id="zStreet" value="In-MilkteaShop" readonly>
 </div>
...
<div class="form">
 <input type="hidden" class="form-control" name="uStat" id="uStat" value="0" recquired>
 </div>
