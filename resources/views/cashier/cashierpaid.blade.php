...
<h3 class="form">To Cancel Your Order?</h3>
 ...
 <form method="POST" action="/cashier/{{ $cash->id }}">
 @csrf
 @method('PUT')
 ...
 <div class="form">
 <input type="text" class="form-control" name="zFirst" id="zFirst" value="{{ $cash->zFirst }}">
 </div>

 <div class="form">
 <input type="text" class="form-control" name="zLast" id="zLast" value="{{$cash->zLast}}" >
 </div>

 <div class="form">
 <button type="submit" class="button1">Yes</button> 
 </form>
 <a href="/cashiers"><button class="button1">No</button></a>
 </div>
</div>
</div>
</div>
