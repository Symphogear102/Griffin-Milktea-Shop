...
<select id="zItem"  name="zItem" value="{{ old('zItem') }}" required autocomplete="zItem">
<option selected="selected" >- Name of Product -</option>
...
<option selected="selected" required>- Quantity -</option>
 ...
 <div class="form"> 
 <input type="hidden" class="form-control" name="zDate" id="zDate" value="<?php echo date("Y-m-d"); ?>" recquired>
 </div>
