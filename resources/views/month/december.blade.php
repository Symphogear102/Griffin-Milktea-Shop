...
<b class="total">Total Sales &nbsp;of December<?php echo date(" - Y "); ?></b>
<div class="totalright1">

Total Sales Now ₱{{ $months->where('zMonth','12')->where('uStat', 0)->sum('zPayment') }}.00
...
<table id="customers1">
        ...
        @if ( $delivery->uStat == '1' && $delivery->zPayment == $delivery->zPayment && $delivery->zYear == date("Y") && $delivery->zMonth == "12" )
        <tr> 
        ...
        @if ( $delivery->zPayment == '0' && $delivery->uStat == '0' && $delivery->zYear == date("Y") && $delivery->zMonth == "12" )
        <tr> 
        <td>{{$delivery->zFirst}}{{$delivery->zLast}}</td>
        <td> {{$delivery->zAdd}},{{$delivery->zStreet}}</td>
        <td> {{$delivery->zContact}}</td>
        ...
        @if ( $delivery->zPayment == TRUE && $delivery->uStat == '0' && $delivery->zYear == date("Y") && $delivery->zMonth == "12" )
        <tr> 
        <td>{{$delivery->zFirst}}{{$delivery->zLast}}</td>
        <td> {{$delivery->zAdd}},{{$delivery->zStreet}}</td>
        <td> {{$delivery->zContact}}</td>
